...
import { GLOBE } from "../utils/constants";
...
const Footer = () => {
  ...
  return (
    <div className="footer">
      ...
      <div className="footer-mobile w-full py-12 bg-[#232F3E] flex flex-col gap-20 text-white lg:hidden h-[22rem]">
        <div className="block1 flex justify-around px-5">
          <div className="topic text-sm flex flex-col gap-5 font-medium">
        ...
        <div className="blobk2 w-full bg-[#131A22] flex flex-col justify-center items-center gap-4 py-8">
          <div className="lang flex gap-2">
            <img src={GLOBE} alt="" />
            <h2 className="text-lg">English</h2>
          </div>
          <div className="sign-in text-sm">
            <h1>
              Already a customer? <Link to="/signin">Sign in</Link>
            </h1>
          </div>
          <h2 className="text-xs">AmazonClone Made with ❤️ in India</h2>
        </div>
      </div>

      <div className="footer-desktop hidden lg:flex flex-col">
